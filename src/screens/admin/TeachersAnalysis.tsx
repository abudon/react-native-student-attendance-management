...
const TeachersAnalysis = () => {
    ...
    useEffect(() => {
        console.log(staffPresent, totalStaffs, lateStaffNumber)
        if (totalStaffs != undefined && staffPresent != undefined){
            ...
            if (lateStaffNumber === 0 && staffPresent === 0){
                const ontime = 0
                const finalPieData  = [
                ...
                const ontime = ((staffPresent - lateStaffNumber)/totalStaffs)*100
                const finalPieData  = [
                    {value: ontime, color: '#177AD5', text:`${ontime}%`},
                    {value: late, color: '#79D2DE', text:`${late}%`},
                    {value: absent, color: '#E23F11', text:`${absent}%`},
    ...
    useEffect(() => {
        ...
        if (everyMonthStaff){
            ...
            console.log('everyday', monthlyStaff)
        }
    }, [everyMonthStaff, everydayAttendanceStaff]);
                        ...
                        >
                            ...
                            >
                                ...
                                <RadioButton.Group onValueChange={(value)=>{
                                    setChoice(value)
                                    setCurrentChoice(choice == 'daily'? everydayAttendanceStaff : monthlyStaff)
                                }} value={choice}>
                                    <Blocks
                                        width={"100%"}
                                        row
